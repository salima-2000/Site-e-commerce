...
<link rel="stylesheet" href="header.css">
        <header>
                ...
                <form action="gestionRecherche.php" method="GET">
                    <img style="width:10%; height:5%;margin-left:2%" src="aseds.jpg"  onMouseOver="afficher('Bienvenue !')" id="logo" alt="header_logo"> 
                    
                <input type="search" name="search" id="header_search"  placeholder="Cherchez ce que vous voulez" aria-label="Search through site content" autocomplete="true" >
