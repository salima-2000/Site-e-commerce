...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 04 fév. 2021 à 20:56
...
(21, 5, 39, 3, 'waiting for validation', '2021-02-04');
...
INSERT INTO `products` (`product_id`, `product_name`, `category`, `product_price`, `product_image`, `product_quantity`, `product_color`, `product_size`, `product_date`) VALUES
(38, 'Casual Pockets Long Sleeve Solid Tops Tunics black', 'FEMME', 17.00, 'Casual Pockets Long Sleeve Solid Tops Tunics gray.jpg', 20, '#757575', 'M', '2021-02-04 12:51:56'),
...
(40, 'Vintage Wool Blend Shawl Neck Outerwear gray', 'HOMME', 20.00, 'Vintage Wool Blend Shawl Neck Outerwear gray.jpg', 10, '#707070', 'L', '2021-02-04 13:43:29');
...
--
ALTER TABLE `commandes`
  MODIFY `commande_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
