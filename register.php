...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        ...
        $sql = "SELECT client_id FROM clients WHERE username = ?";
    ...
    if(empty($username_err) && empty($email_err) && empty($password_err) && empty($confirm_password_err) && empty($phone_number_err)){
        ...
        $sql = "INSERT INTO clients (username,email,password,phone_number) VALUES (?, ?, ?, ?)";
    ...
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group <?php echo (!empty($email_err)) ? 'has-error' : ''; ?>">
                ...
                <input type="tel" pattern="[0-9]{10}" name="phone_number" class="form-control" value="<?php echo $phone_number; ?>" required>
