...
<?php include 'header.php';?>
    ...
    <form id="connexion_form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
        ...
        <textarea id="body" rows="4" cols="50" name="body" form="connexion_form" placeholder="Article" ></textarea><br> 
        ...
        <p style="color:white;margin-top:5%;" ><?php echo $msg ?></p><br>
        <input  type="submit" value="Login" id="submit" name="insert">
